...
import com.netsuite.webservices.v2014_2.setup.customization.CrmCustomField;
...
import com.netsuite.webservices.v2014_2.setup.customization.CustomRecordCustomField;
import com.netsuite.webservices.v2014_2.setup.customization.CustomRecordType;
import com.netsuite.webservices.v2014_2.setup.customization.EntityCustomField;
import com.netsuite.webservices.v2014_2.setup.customization.ItemCustomField;
import com.netsuite.webservices.v2014_2.setup.customization.ItemNumberCustomField;
import com.netsuite.webservices.v2014_2.setup.customization.ItemOptionCustomField;
import com.netsuite.webservices.v2014_2.setup.customization.OtherCustomField;
import com.netsuite.webservices.v2014_2.setup.customization.TransactionBodyCustomField;
import com.netsuite.webservices.v2014_2.setup.customization.TransactionColumnCustomField;
...
public enum RecordTypeEnum implements RecordTypeDesc {
    ...
    APP_DEFINITION("appDefinition", "AppDefinition", AppDefinition.class, "appDefinition"),

    APP_PACKAGE("appPackage", "AppPackage", AppPackage.class, "appPackage"),
    ...
    BILLING_SCHEDULE("billingSchedule", "BillingSchedule", BillingSchedule.class, null),
    ...
    CHARGE("charge", "Charge", Charge.class, null),
    ...
    CONTACT_CATEGORY("contactCategory", "ContactCategory", ContactCategory.class, null),

    CONTACT_ROLE("contactRole", "ContactRole", ContactRole.class, null),

    COST_CATEGORY("costCategory", "CostCategory", CostCategory.class, "item"),

    COUPON_CODE("couponCode", "CouponCode", CouponCode.class, null),
    ...
    CURRENCY_RATE("currencyRate", "CurrencyRate", CurrencyRate.class, null),

    CUSTOMER("customer", "Customer", Customer.class, "customer"),

    CUSTOMER_CATEGORY("customerCategory", "CustomerCategory", CustomerCategory.class, null),
    ...
    CUSTOMER_STATUS("customerStatus", "CustomerStatus", CustomerStatus.class, null),

    CUSTOM_LIST("customList", "CustomList", CustomList.class, null),
    ...
    EXPENSE_CATEGORY("expenseCategory", "ExpenseCategory", ExpenseCategory.class, null),
    ...
    GLOBAL_ACCOUNT_MAPPING("globalAccountMapping", "GlobalAccountMapping", GlobalAccountMapping.class, null),
    ...
    ITEM_ACCOUNT_MAPPING("itemAccountMapping", "ItemAccountMapping", ItemAccountMapping.class, null),

    ITEM_CUSTOM_FIELD("itemCustomField", "ItemCustomField", ItemCustomField.class, null),

    ITEM_DEMAND_PLAN("itemDemandPlan", "ItemDemandPlan", ItemDemandPlan.class, null),
    ...
    ITEM_REVISION("itemRevision", "ItemRevision", ItemRevision.class, null),

    ITEM_SUPPLY_PLAN("itemSupplyPlan", "ItemSupplyPlan", ItemSupplyPlan.class, null),

    JOB("job", "Job", Job.class, "job"),

    JOB_STATUS("jobStatus", "JobStatus", JobStatus.class, null),

    JOB_TYPE("jobType", "JobType", JobType.class, null),
    ...
    NOTE_TYPE("noteType", "NoteType", NoteType.class, null),
    ...
    PARTNER_CATEGORY("partnerCategory", "PartnerCategory", PartnerCategory.class, null),
    ...
    PAYMENT_METHOD("paymentMethod", "PaymentMethod", PaymentMethod.class, null),

    PAYROLL_ITEM("payrollItem", "PayrollItem", PayrollItem.class, null),
    ...
    UNITS_TYPE("unitsType", "UnitsType", UnitsType.class, null),

    VENDOR("vendor", "Vendor", Vendor.class, "vendor"),

    VENDOR_BILL("vendorBill", "VendorBill", VendorBill.class, "transaction"),

    VENDOR_CATEGORY("vendorCategory", "VendorCategory", VendorCategory.class, null),
    ...
    WIN_LOSS_REASON("winLossReason", "WinLossReason", WinLossReason.class, null),
