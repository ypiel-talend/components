...
package org.talend.components.netsuite.v2016_2.client.tools;
...
public class MetaDataModelGenImpl extends MetaDataModelGen {
    ...
    public MetaDataModelGenImpl() {
        recordTypeEnumClassName = ClassName.get(
                "org.talend.components.netsuite.v2016_2.client.model", "RecordTypeEnum");
        searchRecordTypeEnumClassName = ClassName.get(
                "org.talend.components.netsuite.v2016_2.client.model", "SearchRecordTypeEnum");

        outputFolder = new File("./components/components-netsuite/components-netsuite-runtime_2016_2/src/main/java");
