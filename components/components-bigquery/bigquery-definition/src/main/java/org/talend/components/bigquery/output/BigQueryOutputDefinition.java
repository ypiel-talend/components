...
public class BigQueryOutputDefinition extends AbstractComponentDefinition {

    public static final String NAME = BigQueryComponentFamilyDefinition.NAME + "Output";

    public static final String RUNTIME = "org.talend.components.bigquery.runtime.BigQueryOutputRuntime";

    public BigQueryOutputDefinition() {
        super(NAME, ExecutionEngine.BEAM);
    }

    @Override
    public Class<? extends ComponentProperties> getPropertyClass() {
        return BigQueryOutputProperties.class;
    }
