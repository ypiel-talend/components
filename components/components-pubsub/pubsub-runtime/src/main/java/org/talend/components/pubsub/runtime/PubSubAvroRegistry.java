...
//TODO(bchen) duplicate from SimpleFileIoAvroRegistry, move both to daikon later
public class PubSubAvroRegistry extends AvroRegistry {

    public static final String RECORD_NAME = "StringArrayRecord";

    public static final String FIELD_PREFIX = "field";

    private static final PubSubAvroRegistry sInstance = new PubSubAvroRegistry();

    /**
     * Hidden constructor: use the singleton.
     */
    private PubSubAvroRegistry() {
    ...
    public static PubSubAvroRegistry get() {
        return sInstance;
    }
    ...
    public static class StringArrayToIndexedRecordConverter implements IndexedRecordConverter<String[], StringArrayIndexedRecord> {
        ...
        public StringArrayIndexedRecord convertToAvro(String[] value) {
            if (schema == null)
                schema = PubSubAvroRegistry.get().inferSchema(value);
