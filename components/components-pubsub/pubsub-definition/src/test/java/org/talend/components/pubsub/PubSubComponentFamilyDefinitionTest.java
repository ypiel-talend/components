...
public class PubSubComponentFamilyDefinitionTest{
    ...
    private final PubSubComponentFamilyDefinition componentFamilyDefinition = new PubSubComponentFamilyDefinition();

    ComponentInstaller.ComponentFrameworkContext ctx = Mockito.mock(ComponentInstaller.ComponentFrameworkContext.class);

    /**
     * Check {@link PubSubComponentFamilyDefinitionTest} returns "PubSub"
     */
    @Test
    public void testGetName() {
        String componentName = componentFamilyDefinition.getName();
        assertEquals(componentName, "PubSub");
    }

    /**
     * Check {@link PubSubComponentFamilyDefinition#install(ComponentInstaller.ComponentFrameworkContext ctx)} which call once the method "registerComponentFamilyDefinition"
     */
    @Test
