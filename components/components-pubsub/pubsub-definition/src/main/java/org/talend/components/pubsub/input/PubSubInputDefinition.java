...
public class PubSubInputDefinition extends AbstractComponentDefinition {

    public static final String NAME = PubSubComponentFamilyDefinition.NAME + "Input";

    public static final String RUNTIME = "org.talend.components.pubsub.runtime.PubSubInputRuntime";

    public PubSubInputDefinition() {
        super(NAME, ExecutionEngine.BEAM);
    }

    @Override
    public Class<? extends ComponentProperties> getPropertyClass() {
        return PubSubInputProperties.class;
    }
