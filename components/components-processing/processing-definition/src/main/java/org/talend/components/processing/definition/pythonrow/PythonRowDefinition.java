...
public class PythonRowDefinition extends AbstractComponentDefinition {
    ...
    public static final String COMPONENT_NAME = "PythonRow";

    public PythonRowDefinition() {
        super(COMPONENT_NAME, ExecutionEngine.BEAM);
    }

    @Override
    public Class<PythonRowProperties> getPropertyClass() {
        return PythonRowProperties.class;
    }
