...
public final class RuntimeInfoProvider {
    ...
    public static final String RUNTIME_CLASS_NAME = "org.talend.components.mongodb.runtime.MongoDBSourceOrSink"; //$NON-NLS-1$
    ...
    /**
     * Returns instance of {@link RuntimeInfo} for Input component with runtime class name tMongoDBInputSource
     * 
     * @return {@link RuntimeInfo} for Input component
     */
    public static RuntimeInfo provideConnectionRuntimeInfo() {
