...
public class KeyValueTable extends ComponentPropertiesImpl {
    ...
    private static final TypeLiteral<List<Object>> REPLICA_PORT = new TypeLiteral<List<Object>>() {// empty
    };

    public Property<List<String>> key = newProperty(REPLICA_HOST, "key");

    public Property<List<Object>> value = newProperty(REPLICA_PORT, "value");
