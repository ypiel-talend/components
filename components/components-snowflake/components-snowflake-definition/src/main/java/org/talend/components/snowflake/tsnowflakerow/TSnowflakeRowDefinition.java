...
public class TSnowflakeRowDefinition extends SnowflakeDefinition {
    ...
    public RuntimeInfo getRuntimeInfo(ExecutionEngine engine, ComponentProperties properties,
        ...
        case NONE:
            return getCommonRuntimeInfo(SnowflakeDefinition.ROW_STANDALONE_CLASS);
        case OUTGOING:
            return getCommonRuntimeInfo(SnowflakeDefinition.ROW_SOURCE_CLASS);
        case INCOMING:
        case INCOMING_AND_OUTGOING:
            return getCommonRuntimeInfo(SnowflakeDefinition.ROW_SINK_CLASS);
        default:
            return null;
        }
