...
public class DelimitedStringConverter implements AvroConverter<String, IndexedRecord> {
	...
	/**
	 * Returns Json string schema
	 * 
	 * @return Json string schema
	 */
	public static class StringJsonIndexedRecord extends ComparableIndexedRecordBase {

        private final Schema schema;

        private final String[] value;

        public StringJsonIndexedRecord(Schema schema, String[] value) {
            this.schema = schema;
            this.value = value;
        }
