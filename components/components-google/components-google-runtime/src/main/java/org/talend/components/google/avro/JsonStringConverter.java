...
/**
 * Converts json string to {@link IndexedRecord} and vice versa
 * 
 ...
 */
public class JsonStringConverter implements AvroConverter<String, IndexedRecord> {
	
	 private final Schema schema;

     private final String[] value;

     public JsonStringConverter(Schema schema, String[] value) {
         this.schema = schema;
         this.value = value;
     }
...
//	private StringConverter[] converters;
	 ...
	 */
     /**
	public JsonStringConverter(Schema schema) {
	 ...
	 */
     /**
	public JsonStringConverter(Schema schema, String delimiter) {
		this.schema = schema;
