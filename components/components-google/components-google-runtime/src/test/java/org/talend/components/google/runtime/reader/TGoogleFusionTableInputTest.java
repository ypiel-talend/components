...
import org.talend.components.google.TGoogleFusionTableInputFamilyDefinition;
import org.talend.components.google.tgooglefusiontableinput.TGoogleFusionTableInputProperties;
import org.talend.daikon.avro.AvroUtils;
import org.talend.daikon.avro.SchemaConstants;

@SuppressWarnings("nls")
public class TGoogleFusionTableInputTest {
    ...
    public ComponentService getComponentService() {
        if (componentService == null) {
            ...
            testComponentRegistry.registerComponentFamilyDefinition(new TGoogleFusionTableInputFamilyDefinition());
    ...
    @Test
    public void testTGoogleFusionTableInputRuntime() throws Exception {
        TGoogleFusionTableInputProperties props = (TGoogleFusionTableInputProperties) getComponentService().getComponentProperties("TGoogleFusionTableInput");

        File tempFile = File.createTempFile("TGoogleFusionTableInputTestFile", ".txt");
        try {
            ...
            TGoogleFusionTableInputSource source = new TGoogleFusionTableInputSource();
            source.initialize(null, props);

            TGoogleFusionTableInputReader reader = source.createReader(null);
