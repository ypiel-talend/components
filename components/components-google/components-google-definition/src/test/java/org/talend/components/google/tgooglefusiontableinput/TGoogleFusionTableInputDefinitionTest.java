...
public class TGoogleFusionTableInputDefinitionTest {
    ...
    public void testGetPropertyClass() {
        ...
        assertThat(canonicalName,
                equalTo("org.talend.components.google.tgooglefusiontableinput.TGoogleFusionTableInputProperties"));
    }
     ...
     * "WRONG_EXECUTION_ENGINE:{component=tGoogleFusionTableInput, requested=DI_SPARK_STREAMING, available=[DI]}");
