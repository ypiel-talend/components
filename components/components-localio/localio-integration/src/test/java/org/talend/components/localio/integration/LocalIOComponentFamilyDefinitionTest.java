...
/**
 * Unit tests to ensure that {@link LocalIOComponentFamilyDefinition} was created as an extensible service.
 */
public class LocalIOComponentFamilyDefinitionTest {
    ...
    public void testServiceLoader() throws Exception {
        ...
        assertThat(spiLoader, hasItem(isA(LocalIOComponentFamilyDefinition.class)));
    }
}
