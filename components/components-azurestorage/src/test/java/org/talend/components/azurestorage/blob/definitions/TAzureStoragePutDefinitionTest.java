...
public class TAzureStoragePutDefinitionTest extends AzureStorageContainerDefinitionTest {

    @Override
    public void setUp() throws Exception {
        azureStorageContainerDefinition = new TAzureStoragePutDefinition();
    }

    @Override
    public void testGetPropertiesClass() {
        assertEquals(TAzureStoragePutProperties.class, azureStorageContainerDefinition.getPropertiesClass());
    }
