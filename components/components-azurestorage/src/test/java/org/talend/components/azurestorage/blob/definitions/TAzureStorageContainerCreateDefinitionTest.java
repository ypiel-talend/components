...
public class TAzureStorageContainerCreateDefinitionTest extends AzureStorageContainerDefinitionTest {

    @Override
    public void setUp() throws Exception {
        azureStorageContainerDefinition = new TAzureStorageContainerCreateDefinition();
    }
    ...
    public void testGetPropertiesClass() {
        assertEquals(TAzureStorageContainerCreateProperties.class, azureStorageContainerDefinition.getPropertyClass());
    }
