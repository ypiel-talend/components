...
public class TAzureStorageContainerListDefinitionTest extends AzureStorageContainerDefinitionTest {
    ...
    public void testGetPropertiesClass() {
        assertEquals(TAzureStorageContainerListProperties.class, azureStorageContainerDefinition.getPropertiesClass());
    }
