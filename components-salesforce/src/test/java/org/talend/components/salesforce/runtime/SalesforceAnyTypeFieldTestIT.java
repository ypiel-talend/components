...
public class SalesforceAnyTypeFieldTestIT extends SalesforceTestBase {
    ...
    public static Schema SCHEMA_CUSTOM_MODULE = SchemaBuilder.builder().record("Schema").fields() //
            ...
            .name(DATE_COLUMN_NAME).prop(SchemaConstants.TALEND_COLUMN_PATTERN, "yyyy-MM-dd").type(AvroUtils._date()).noDefault() //
            .name(DATETIME_COLUMN_NAME).prop(SchemaConstants.TALEND_COLUMN_PATTERN, "yyyy-MM-dd'T'HH:mm:ss'.000Z'").type(AvroUtils._date()).noDefault() //
    ...
    public static Schema SCHEMA_QUERY_HISTORY = SchemaBuilder.builder().record("Schema").fields() //
            ...
            .name("CreatedDate").prop(SchemaConstants.TALEND_COLUMN_PATTERN, "yyyy-MM-dd'T'HH:mm:ss'.000Z'").type(AvroUtils._date()).noDefault() //
    ...
    private void updateRecord() throws Throwable {
        ...
        outProps.module.schemaListener.afterSchema();
